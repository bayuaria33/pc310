...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE produk SET nama_produk = '$nama_produk', keterangan = '$keterangan', harga = '$harga', jumlah= '$jumlah' WHERE produk_id=$produk_id";
...
<head>
    ...
    <title>PC-3-10 Edit product</title>
...
<body>
    ...
    <div class="container">
        ...
        <?php
        $produk_id = $_GET['produk_id'];
        $sql = "SELECT * FROM produk WHERE produk_id = $produk_id LIMIT 1 ";
        $result = mysqli_query($conn, $sql);
